...
.controller('feedbackController', ['$scope','$http','restApi','shareData','$timeout','$state', function($scope,$http,restApi,shareData,$timeout,$state) {
	var feedbackCtrl =this;
	feedbackCtrl.objectMessage={};
    feedbackCtrl.progress = 0;
	prog =0;

	feedbackCtrl.getComment = function (object){
    feedbackCtrl.objectMessage=object;   
    postComment();
    feedbackCtrl.progressfunction();
  };
   ...
   feedbackCtrl.pattern = {
    ...
    feedbackCtrl.progressfunction = function(){
        ...
        if(prog ===100)
            return $state.go('form.newsfeeds');
              ...
              prog++;
            feedbackCtrl.progress = prog;
           
            $timeout(feedbackCtrl.progressfunction,100);
